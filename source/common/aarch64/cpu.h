...
#if HAVE_NEON_I8MM
// PF_ARM_V82_I8MM_INSTRUCTIONS_AVAILABLE directly indicates Neon I8MM
// (Armv8.6). PF_ARM_SVE_I8MM also implies Neon I8MM. Check both so that
// cores with Neon I8MM but no SVE (e.g. Qualcomm Oryon / Snapdragon X Elite,
// which report V82_I8MM=1 but SVE_I8MM=0) are detected.
